...
public Document getDocument(LatLng start, LatLng end, String mode) {
    ...
    //String url = "http://maps.googleapis.com/maps/api/directions/xml?origin=41.561653,-8.397139&destination=41.557183,-8.39657&sensor=false&units=metric&mode=driving";
    Log.d("url", url);
